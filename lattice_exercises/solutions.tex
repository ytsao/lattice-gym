...
\begin{exo}
    ...
    \begin{sol}
        $b_1 \join b_1^\prime = \N = 1 \triangleq b_1 \cup b_1^\prime = b_1 \cup (\N \setminus b_1) = \N$ \\ 
        $b_1 \meet b_1^\prime = \emptyset = 0 \triangleq b_1 \cap b_1^\prime = b_1 \cap (\N \setminus b_1) = \emptyset$ \\ 
        $(b_1^\prime)^\prime = (\N \setminus b_1)^\prime = \N \setminus (\N \setminus b_1) = b_1$
    \end{sol}
\end{exo}
